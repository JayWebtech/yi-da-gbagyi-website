            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="hidden items-center justify-end pr-16 sm:flex lg:pr-0">
                ...
                <button
                  ...
                  className="flex h-8 w-8 items-center justify-center mr-5 text-body-color duration-300 dark:text-white"
                >
                  <span>
                    <svg
                      viewBox="0 0 16 16"
                ...
                <Link
                    href="https://play.google.com/store/apps/details?id=com.jaykosai.gbagyi_development_app"
                    className={`flex gap-2 items-center rounded-lg px-6 py-3 text-base font-medium text-white duration-300 ease-in-out ${
                      sticky
